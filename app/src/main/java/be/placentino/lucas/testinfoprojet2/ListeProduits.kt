...
class ListeProduits {
    ...
    init { // Liste prédeterminée de produits, hard-codée dans l'app (on pourrait l'importer d'un JSON ou une database etc)
        listeProduits.add(Produit("1","Lunettes de soleil", "26.99", R.drawable.sunglasses_giorgio_trovato_unsplash))
        ...
        listeProduits.add(Produit("8","Skateboard Petit", "79.99",R.drawable.pennyboard_mike_meyers_unsplash))
        listeProduits.add(Produit("9","Sticker", "1.23",R.drawable.sticker_mathias_reding_unsplash))
        listeProduits.add(Produit("10","Lunettes de soleil", "27.99",R.drawable.sunglasseswomen_annie_theby_unsplash))
        ...
        listeProduits.add(Produit("14","Chaussures homme", "85.99",R.drawable.shoe_imani_bahati_unsplash))
